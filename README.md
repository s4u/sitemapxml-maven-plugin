# Maven Sitemap generator plugin [![Build Status](https://travis-ci.org/s4u/sitemapxml-maven-plugin.svg?branch=master)](https://travis-ci.org/s4u/sitemapxml-maven-plugin)
